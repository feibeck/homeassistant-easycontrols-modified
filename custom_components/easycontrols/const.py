...
VARIABLE_PARTY_MODE_FAN_STAGE = IntModbusVariable("v00092", 3)
...
VARIABLE_WARNINGS = IntModbusVariable("v01124", 3)
VARIABLE_INFOS = IntModbusVariable("v01125", 3)
VARIABLE_INFO_FILTER_CHANGE = FlagModbusVariable("v01125", 3, INFO_FILTER_CHANGE_FLAG)
VARIABLE_ERROR_DELETE = IntModbusVariable("v02015", 1)
